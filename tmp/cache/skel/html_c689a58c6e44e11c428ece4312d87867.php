 ...
 * Compile :   Fri, 04 Oct 2013 09:41:08 GMT (0.05s)
 * Boucles :   _doc
 */ 
//
// <BOUCLE documents>
//
function BOUCLE_dochtml_c689a58c6e44e11c428ece4312d87867(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
//
function html_c689a58c6e44e11c428ece4312d87867($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = (BOUCLE_dochtml_c689a58c6e44e11c428ece4312d87867($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_c689a58c6e44e11c428ece4312d87867', $Cache, $page);
}
