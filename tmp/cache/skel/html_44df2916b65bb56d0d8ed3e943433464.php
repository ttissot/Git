 ...
 * Compile :   Wed, 07 Nov 2012 14:29:42 GMT (0.05s)
...
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_premshtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_first_arthtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
					' .
BOUCLE_illustrhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					
					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_arthtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_planhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
						' .
BOUCLE_planhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						');
	}
...
// <BOUCLE rubriques>
//
function BOUCLE_firstrubhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
				<div id="illustr">
					' .
BOUCLE_first_arthtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="plan">
						' .
BOUCLE_rubhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		(('
						<ul>
						' .
		BOUCLE_arthtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
		'
						') . $t1 . '
						</ul>
						') :
...
'
						' .
BOUCLE_art_planhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
// <BOUCLE rubriques>
//
function BOUCLE_rubrique_principalhtml_44df2916b65bb56d0d8ed3e943433464(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete2">
					' .
BOUCLE_originehtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
BOUCLE_premshtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				
				' .
BOUCLE_firstrubhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
				<div class="clear"></div>
			</div>
			' .
...
//
function html_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 0"); ?>'.'<?php header("Cache-Control: no-store, no-cache, must-revalidate"); ?><?php header("Pragma: no-cache"); ?>' .
BOUCLE_rubrique_principalhtml_44df2916b65bb56d0d8ed3e943433464($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_44df2916b65bb56d0d8ed3e943433464', $Cache, $page);
}
