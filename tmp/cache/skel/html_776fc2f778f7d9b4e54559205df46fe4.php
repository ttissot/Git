 ...
 * Compile :   Wed, 14 Nov 2012 23:25:26 GMT (0.03s)
 * Boucles :   _origine, _illustr, _compte_vignettes, _first_art, _art_de_garde, _rub, _art, _others_arts, _plan, _art_plan, _rubrique_principal
 */ 
//
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_first_arthtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
					' .
BOUCLE_illustrhtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'

					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_arthtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_planhtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
						' .
BOUCLE_planhtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						');
	}
...
// <BOUCLE rubriques>
//
function BOUCLE_rubrique_principalhtml_776fc2f778f7d9b4e54559205df46fe4(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete4">
					' .
BOUCLE_originehtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'
				...
				<div id="illustr">
					' .
BOUCLE_first_arthtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="plan">
						' .
BOUCLE_rubhtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		(('
						<ul>
						' .
		BOUCLE_arthtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
		'
						') . $t1 . '
						</ul>
						') :
...
'
						' .
BOUCLE_art_planhtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
//
function html_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 7200"); ?>' .
BOUCLE_rubrique_principalhtml_776fc2f778f7d9b4e54559205df46fe4($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_776fc2f778f7d9b4e54559205df46fe4', $Cache, $page);
}
