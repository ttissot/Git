<?php
/*
 * Squelette : squelettes/article-17.html
 * Date :      Wed, 07 Nov 2012 14:17:41 GMT
 * Compile :   Wed, 14 Nov 2012 17:36:59 GMT (0.03s)
 * Boucles :   _origine, _illustr, _compte_vignettes, _rub, _others_arts, _plan, _art_de_garde, _article_principal
 */ 
//
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
					...
					<div class="plan">
						' .
BOUCLE_rubhtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		('
						<ul>
						' . $t1 . '
						</ul>
...
'
						' .
BOUCLE_planhtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
// <BOUCLE articles>
//
function BOUCLE_article_principalhtml_225b7fbfc8571722821ca91ae5bc413e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete2">
					' .
BOUCLE_originehtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'<?php
	...
	\'id_secteur\' => ' . argumenter_squelette('2') . ',
...
'
				...
				<div id="illustr">
					' .
BOUCLE_illustrhtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
'
				...
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
				</div>
				<div class="clear"></div>
			</div>
...
//
// Fonction principale du squelette squelettes/article-17.html
//
function html_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 86400"); ?>' .
BOUCLE_article_principalhtml_225b7fbfc8571722821ca91ae5bc413e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_225b7fbfc8571722821ca91ae5bc413e', $Cache, $page);
}
