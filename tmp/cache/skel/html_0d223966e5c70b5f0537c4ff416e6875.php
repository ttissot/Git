 ...
 * Compile :   Wed, 14 Nov 2012 16:01:59 GMT (0.03s)
...
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_first_arthtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
					' .
BOUCLE_illustrhtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					
					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_arthtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_planhtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
						' .
BOUCLE_planhtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						');
	}
...
// <BOUCLE rubriques>
//
function BOUCLE_rubrique_principalhtml_0d223966e5c70b5f0537c4ff416e6875(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete2">
					' .
BOUCLE_originehtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'
				...
				<div id="illustr">
					' .
BOUCLE_first_arthtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="plan">
						' .
BOUCLE_rubhtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		(('
						<ul>
						' .
		BOUCLE_arthtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
		'
						') . $t1 . '
						</ul>
						') :
...
'
						' .
BOUCLE_art_planhtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
//
function html_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 0"); ?>'.'<?php header("Cache-Control: no-store, no-cache, must-revalidate"); ?><?php header("Pragma: no-cache"); ?>' .
BOUCLE_rubrique_principalhtml_0d223966e5c70b5f0537c4ff416e6875($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_0d223966e5c70b5f0537c4ff416e6875', $Cache, $page);
}
