<?php
/*
 * Squelette : squelettes/article-4.html
 * Date :      Wed, 07 Nov 2012 14:17:41 GMT
 * Compile :   Wed, 14 Nov 2012 17:36:38 GMT (0.03s)
 * Boucles :   _origine, _illustr, _compte_vignettes, _rub, _others_arts, _plan, _art_de_garde, _article_principal
 */ 
//
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
					...
					<div class="plan">
						' .
BOUCLE_rubhtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		('
						<ul>
						' . $t1 . '
						</ul>
...
'
						' .
BOUCLE_planhtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
// <BOUCLE articles>
//
function BOUCLE_article_principalhtml_545ed4edc8a710503d83b00052bafb06(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete4">
					' .
BOUCLE_originehtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'<?php
	...
	\'id_secteur\' => ' . argumenter_squelette('4') . ',
...
'
				...
				<div id="illustr">
					' .
BOUCLE_illustrhtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
'
				...
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
				</div>
				<div class="clear"></div>
			</div>
...
//
// Fonction principale du squelette squelettes/article-4.html
//
function html_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 86400"); ?>' .
BOUCLE_article_principalhtml_545ed4edc8a710503d83b00052bafb06($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_545ed4edc8a710503d83b00052bafb06', $Cache, $page);
}
