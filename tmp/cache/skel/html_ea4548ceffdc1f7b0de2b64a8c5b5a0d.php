 ...
 * Compile :   Wed, 14 Nov 2012 15:59:14 GMT (0.03s)
...
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_premshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_first_arthtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
					' .
BOUCLE_illustrhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'

					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_arthtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_planhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
						' .
BOUCLE_planhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						');
	}
...
// <BOUCLE rubriques>
//
function BOUCLE_firstrubhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
				<div id="illustr">
					' .
BOUCLE_first_arthtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="plan">
						' .
BOUCLE_rubhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		(('
						<ul>
						' .
		BOUCLE_arthtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
		'
						') . $t1 . '
						</ul>
						') :
...
'
						' .
BOUCLE_art_planhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
// <BOUCLE rubriques>
//
function BOUCLE_rubrique_principalhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete3">
					' .
BOUCLE_originehtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
BOUCLE_premshtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>

				' .
BOUCLE_firstrubhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
				<div class="clear"></div>
			</div>
			' .
...
//
function html_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 7200"); ?>' .
BOUCLE_rubrique_principalhtml_ea4548ceffdc1f7b0de2b64a8c5b5a0d($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_ea4548ceffdc1f7b0de2b64a8c5b5a0d', $Cache, $page);
}
