<?php
/*
 * Squelette : dist/formulaires/login.html
 * Date :      Wed, 07 Nov 2012 14:17:39 GMT
 * Compile :   Wed, 07 Nov 2012 14:29:04 GMT (0.11s)
 * Pas de boucle
 */ 

//
// Fonction principale du squelette dist/formulaires/login.html
//
function html_cc36d1dd83e9dc843f48aa7844735c95($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
...
' .
((strval($t1 = interdire_scripts(entites_html($Pile[0]['echec_visiteur'])))!='') ?
		($t1 . ('
<fieldset class="reponse_formulaire">
<legend>' .
	_T('public/spip/ecrire:avis_erreur_visiteur') .
	'</legend>
<p>' .
	_T('public/spip/ecrire:texte_erreur_visiteur') .
	'</p>
</fieldset>')) :
		('')) .
'
...
');
	...
	return analyse_resultat_skel('html_cc36d1dd83e9dc843f48aa7844735c95', $Cache, $page);
}
