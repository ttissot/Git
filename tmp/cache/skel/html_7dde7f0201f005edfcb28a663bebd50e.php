<?php
/*
 * Squelette : squelettes/article-2.html
 * Date :      Wed, 07 Nov 2012 14:17:41 GMT
 * Compile :   Wed, 14 Nov 2012 17:36:35 GMT (0.03s)
 * Boucles :   _origine, _illustr, _compte_vignettes, _rub, _others_arts, _plan, _article_principal
 */ 
//
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_article_principalhtml_7dde7f0201f005edfcb28a663bebd50e(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete2">
					' .
BOUCLE_originehtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'
				...
				<div id="illustr">
					' .
BOUCLE_illustrhtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
'
					...
					<div class="plan">
						' .
BOUCLE_rubhtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		('
						<ul>
						' . $t1 . '
						</ul>
...
'
						' .
BOUCLE_planhtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
//
// Fonction principale du squelette squelettes/article-2.html
//
function html_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 86400"); ?>' .
BOUCLE_article_principalhtml_7dde7f0201f005edfcb28a663bebd50e($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_7dde7f0201f005edfcb28a663bebd50e', $Cache, $page);
}
