 ...
 * Compile :   Wed, 14 Nov 2012 15:28:42 GMT (0.20s)
...
// <BOUCLE rubriques>
//
function BOUCLE_originehtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_illustrhtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_compte_vignetteshtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_first_arthtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
					' .
BOUCLE_illustrhtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'

					' .
((strval($t1 = BOUCLE_compte_vignetteshtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		($t1 . ('
					' .
...
// <BOUCLE articles>
//
function BOUCLE_art_de_gardehtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE rubriques>
//
function BOUCLE_rubhtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_arthtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_others_artshtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE documents>
//
function BOUCLE_planhtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
// <BOUCLE articles>
//
function BOUCLE_art_planhtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
	...
	while ($Pile[$SP] = @spip_abstract_fetch($result,"")) {
		...
		$t0 .= ('
						' .
BOUCLE_planhtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						');
	}
...
// <BOUCLE rubriques>
//
function BOUCLE_rubrique_principalhtml_03f0e98d5e57f3b2da1a001cf6f57a59(&$Cache, &$Pile, &$doublons, &$Numrows, $SP) {
...
'
			...
			<div id="content_main">
				<div class="entete3">
					' .
BOUCLE_originehtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					' .
'
					' .
...
'
				...
				<div id="illustr">
					' .
BOUCLE_first_arthtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="clear"></div>
				</div>
				<div id="principal">
					' .
BOUCLE_art_de_gardehtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
					<div class="plan">
						' .
BOUCLE_rubhtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
						' .
((strval($t1 = BOUCLE_others_artshtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP))!='') ?
		(('
						<ul>
						' .
		BOUCLE_arthtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
		'
						') . $t1 . '
						</ul>
						') :
...
'
						' .
BOUCLE_art_planhtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
...
//
function html_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons=array(), $Numrows=array(), $SP=0) {
	$page = ('<?php header("X-Spip-Cache: 7200"); ?>' .
BOUCLE_rubrique_principalhtml_03f0e98d5e57f3b2da1a001cf6f57a59($Cache, $Pile, $doublons, $Numrows, $SP) .
'
');

	return analyse_resultat_skel('html_03f0e98d5e57f3b2da1a001cf6f57a59', $Cache, $page);
}
