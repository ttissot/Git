...
jQuery.fn.codaSlider = function(settings) {
	...
	return this.each(function(){
		...
		container.each(function(i) {
			...
			jQuery(this).before("<div class='stripNavL' id='stripNavL" + j + "'><a href='#'><span class='hide'>Left</span></a><\/div>");
			jQuery(this).after("<div class='stripNavR' id='stripNavR" + j + "'><a href='#'><span class='hide'>Right</span></a><\/div>");
